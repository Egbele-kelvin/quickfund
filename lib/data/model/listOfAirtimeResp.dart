class ListOfAirtime {
  ...
  factory ListOfAirtime.fromJson(Map<String, dynamic> json) => ListOfAirtime(
    status: json["status"] == null ? null : json["status"],
    message: json["message"] == null ? null : json["message"],
    data: json["data"] == null ? null : List<AirtimeData>.from(json["data"].map((x) => AirtimeData.fromJson(x))),
...
class AirtimeData {
  ...
  factory AirtimeData.fromJson(Map<String, dynamic> json) => AirtimeData(
